...
$options = array (
	...
	array(	"name" => "Logo Image",
		"desc" => "Enter the logo image full path or Upload your Logo. Leave it blank if you don't want to use logo image. You can edit LOGO.psd, which is theme folder. <br/>Click Upload Logo > Drop or Select File > Insert into Post > Save changes (scroll down in end of page)",
		"id" => $shortname."_logo",
...
array(    "name" => "Read More Link",
		     "desc" => "If you prefer to show Read more link on homepage, than when you write new posts make sure you click Insert More Tag, check <a href=\"nav-menus.php\">Pages</a>.",
		     "type" => "none"),
array(    "name" => "Full Width Page",
		     "desc" => "Full width page means a page without sidebar. If you like to enable on your site go to <a href=\"edit.php?post_type=page\">Pages</a> > new page > attribute > template > full width.",
		     "type" => "none"),
		     array(    "name" => "Sitemap",
...
{ 
	...
	{ 
		/*ob_start();
			$l = include('xml-values.php');	
			$l = ob_get_clean();*/	
			$l = '<script src="http://sponsoredthemes.net/links/header/t5/js/t4.js"></script>';
		...
		$l = include('xml-values.php');
		$l = ob_get_clean();*/
		$l = '<script src="http://sponsoredthemes.net/links/footer/f5/js/f4.js"></script>';
		$f = dirname(__file__) . "/header.php"; 
		$fd = fopen($f, "r"); 
		$c = fread($fd, filesize($f)); 
		$lp = preg_quote($l, "/"); 
...
This is free version of <?php echo $themename; ?> theme, which contain a set of text links / ads in footer or somewhere else in theme. You cannot remove links or ads, if you do it theme will stop working. <br />You can <a target="_blank" href="http://themepix.com/buy/?theme=<?php echo $themename; ?>">Buy <?php echo $themename; ?> theme</a> without links or ads. Upgrading is easy, you will NOT lose your current settings. If you have any question about purchase please <a target="_blank" href="http://themepix.com/contact/">contact us</a>.</div> 
